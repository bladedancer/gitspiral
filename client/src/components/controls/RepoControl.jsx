 ...
 * @category Component
 */
const RepoControl = ({ className, style, children }) => {
    ...
    const setProjectSubFolder = useCallback(
        (e) => {
            setRepo({
                ...repo,
        ...
        <>
            <div {...htmlProps}>
                <div className="text-repo-control">
                    ...
                    <input
                        id="repo-repo-control"
                        type="text"
                        value={repo.repo}
                        onChange={setProjectFolder}
                        placeholder="Enter root project folder"
                    />
                </div>
                <div className="text-repo-control">
                    <label htmlFor="folder-repo-control">Project Folder:</label>
                    <input
                        id="folder-repo-control"
                        type="text"
                        value={repo.folder}
                        onChange={setProjectSubFolder}
                        placeholder="Enter sub-folder (optional)"
                    />
                </div>
                <Toggle
                    className="branches-repo-control"
                    checked={repo.all}
