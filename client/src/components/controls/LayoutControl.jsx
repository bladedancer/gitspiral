        ...
        <>
            ...
            <div {...htmlProps}>
                <button
                    ...
                    title="Heat map"
                    className={`heat ${heat ? 'checked' : ''}`}
                >
                    {children ? (
                        children[0]
                    ) : (
                        <FiThermometer style={{ width: '1em' }} />
                    )}
                </button>
            </div>
            <div {...htmlProps}>
                <button
                    onClick={layout.current && layout.current.zoomIn}
                    title="Zoom In"
                >
                    {children ? (
                        children[0]
            ...
            <div {...htmlProps}>
                <button
                    onClick={layout.current && layout.current.zoomOut}
                    title="Zoom Out"
                >
                    {children ? (
                        children[1]
            ...
            <div {...htmlProps}>
                <button
                    onClick={layout.current && layout.current.fit}
